...
@section('container')
    ...
    <div class=" offset-2 col-md-8 grid-margin stretch-card ">
        <div class="card">
            <h4 class="card-header text-center">Edit Invoice</h4>
            <div class="card-body">


                <form method="post" action="{{ route('invoice.update',$invoice->id) }}" class="tab-content tab-content-basic" id="invoice_form">
                        ...
                        <select class="form-control border border-danger handler_name" name="user_id"  required>
                            ...
                            @foreach($roles as $role)
                                ...
                                @foreach($role->users as $user)
                                    ...
                                    <option @if($user->id == $invoice->user_id) {{ 'selected' }} @endif value="{{ $user->id }}">{{ $user->name }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control invoice_for" type="text" name="invoice_for" value="{{ $invoice->invoice_for }}" placeholder="insert deatails for payment" required/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            ...
                            <label>Amount</label>
                            <input class="form-control amount" type="text" value="{{ $invoice->amount }}" name="amount" placeholder="Insert Required Amount" required/>
                    ...
                    <div class="form-group d-flex flex-row-reverse">
                        ...
                        <button type="button" class="btn btn-outline-success create_invoice_button">Edit</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-success  invoice_submit_button" data-dismiss="modal">Update</button>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            showSwal('success-message','Invoice','Invoice Edited Successfully');
